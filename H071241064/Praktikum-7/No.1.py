    ...
    while True:
        ...
        try:
            ...
            if pilihan == 0:
                ...
                print("Pilihan tidak valid. Silakan pilih nomor yang ada dalam  daftar.")
        except ValueError:
...
def daftar_tiket():
    while True:
        ...
        try:
            ...
            print("Pilihan harus berbentuk angka.")
    ...
    while True:
        ...
        try:
            ...
            if pilihan == 0:
                ...
                print("Pilihan tidak valid. Silahkan pilih nomor yang ada dalam daftar.")
        except ValueError:
            print("Pilihan harus berbentuk angka.")
